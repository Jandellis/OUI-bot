        ...
        while (true) {
            try {
                ...
                Mono<Void> login = client.withGateway((GatewayDiscordClient gateway) -> {
                    ...
                    //import data
                    Mono<Void> inputExportData = gateway.on(MessageCreateEvent.class, event -> {
                        Message message = event.getMessage();
                    ...
                    Mono<Void> report = gateway.on(MessageCreateEvent.class, event -> {
                        Message message = event.getMessage();
                    ...
                    Mono<Void> warn = gateway.on(MessageCreateEvent.class, event -> {
                        Message message = event.getMessage();
                    ...
                    //create hit list
                    Mono<Void> hit = gateway.on(MessageCreateEvent.class, event -> {
                        Message message = event.getMessage();
                        String param = "ouihit";
...
//                                int level = Integer.parseInt(action);
                                ...
                                //top x members to kick
//                                int count = 0;

//                                for (KickMember kickMember : nonServerMembers) {
//                                    if (count < 2) {
//                                        if (kickMember.daysNoWork > 1 || kickMember.daysUnhappy > 1) {
...
//                                    if (count < 2) {
//                                        channel.createMessage("<@" + kickMember.id + ">").block();
//                                        count++;
//                                    }
//                                }
...
//                                            channel.createMessage(kickMember.id.toString()).block();
                    ...
                    Mono<Void> kicked = gateway.on(MessageCreateEvent.class, event -> {
                        Message message = event.getMessage();
                        String param = "!f kick";
...
//                                }).block();
                    ...
                    //watch for kicked users
                    Mono<Void> welcome = gateway.on(MessageCreateEvent.class, event -> {
                        Message message = event.getMessage();
                        String param = "accept";
...
//                                author.getPrivateChannel().flatMap(c -> c.createMessage(spec -> spec.setContent(sb.toString()))).block();


                                author.getPrivateChannel().flatMap(channel -> {
                                    System.out.println("got DM channel");
                    ...
                    Mono<Void> gift = gateway.on(MessageCreateEvent.class, event -> {
                        Message message = event.getMessage();
                    ...
                    //work out who is in the giveaway list
                    Mono<Void> giveaway2 = gateway.on(MessageCreateEvent.class, event -> {
                        Message message = event.getMessage();
                        String param = "gifts";
                    ...
                    Mono<Void> giveaway = gateway.on(MessageCreateEvent.class, event -> {
                        Message message = event.getMessage();
                    ...
                    //work out how much people got in
                    Mono<Void> giveawayTotal = gateway.on(MessageCreateEvent.class, event -> {
                        Message message = event.getMessage();
